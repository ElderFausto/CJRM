...
const numberInAscendingOrder = getArrayCopy(numbers).sort((item1, item2) => item1 - item2)
...
const copyRandomNumbers = randomNumbers.find(number => number > 50)

console.log(copyRandomNumbers);
/*
  05
...
//metodo com map
// const topBrazilMoviesLi = topBrazilMovies
...
ul.innerHTML = topBrazilMoviesLi
/*
  10
