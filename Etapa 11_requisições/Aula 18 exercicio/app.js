...
const getDataUsers = url => new Promise((resolve, reject) => {
    const request = new XMLHttpRequest()

    request.addEventListener('readystatechange', () => {
      const isRequestIsOk = request.readyState === 4 && request.status === 200
      const isRequestIsNotOk = request.readyState === 4
...
*/
const sul = ['sc', 'pr', 'rs']
const sudeste = ['mg', 'es', 'rj', 'sp']

let brasil = sul.concat(sudeste)

brasil.unshift('am', 'ac', 'ro')
...
/*
  ...
  - Percorra o array `brasil` e verifique se os estados tem mais de 7 letras 
    ...
    every.
*/
const nordeste = ['ma', 'pi', 'rn', 'ce', 'pb', 'ba', 'pe', 'al', 'se']
...
const message = hasMoreThan7Letters 
  ...
  : 'nem todos os estados possuem 7 letras'
/*
  05
