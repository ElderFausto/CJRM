...
const getDivisible2Or3 = number => number % 2 === 0 || number % 3 === 0
const divisibleBy2Or3 = numbers.filter(getDivisible2Or3)
...
const splitMyName = myName => myName
  .split('')
  .forEach((letter, index) => {
  console.log(`${letter} é a ${index + 1} letra do meu nome.`)
})
...
console.log(filter([0, 1, 2], item => item < 2))
