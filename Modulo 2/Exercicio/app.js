...
// } else {
//   console.log('existe leao no array');
// }
...
//     if(sum > sumLimit) {
//       console.log(`A soma ultrapassou ${sumLimit}. Até aqui, o valor atual é ${sum}`);
//       break
//     } 
//   sum += randomNumbers[i]
...
switch (number) {
  ...
  case 1:
    console.log(`${numberMessage} ${number}`);
  default:
    console.log(`${numberMessage} ${number} é qualquer número, exceto 0 e 1`);
    break;
}
