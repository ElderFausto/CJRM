...
const fevereiro = months.indexOf('Fevereiro')
...
*/
console.log(presentData.getFullYear());
/*
  04
  ...
  - Exiba o objeto no console.
*/
const past = new Date('Feb 01 2023 10:55:00')
console.log(past);
/*
  05
...
/*
  ...
  - Exiba o objeto no console.
*/
const future = new Date('Jun 2023 10:00:00')
console.log(future);
/*
  07
